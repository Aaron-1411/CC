...
export const PLEDGES: Record<string, PartyPromise[]> = {
  labour: [
    ...
    },
    {
      ...
      status: "in-progress",
      detail:
        "Growth mission underway; ONS estimates 2025 GDP growth at 1.4% (up from 1.0% in 2024).",
    ...
    },
    {
      ...
      status: "in-progress",
      detail:
        "Net migration fell to 171,000 in the year ending December 2025 (ONS), down sharply from a peak above 900,000.",
      sourceUrl:
        "https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/internationalmigration/bulletins/internationalmigrationbulletin/latest",
    ...
    },
    {
      ...
      sourceUrl:
        "https://www.gov.uk/government/news/thousands-of-children-to-benefit-from-free-breakfast-clubs",
  ...
  conservative: [
    {
      ...
      status: "proposed",
      detail:
        "A pledge made in every Conservative manifesto 2010–2024. Net migration rose to a record 906,000 in the year to June 2023 while they were in government. Now an opposition policy for the next election.",
      sourceUrl:
        "https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/internationalmigration/bulletins/internationalmigrationbulletin/latest",
      sourceLabel: "ONS Migration Stats",
    },
    {
      ...
      status: "proposed",
      detail:
        "Kemi Badenoch has proposed more private partnerships and management cuts. NHS waiting lists grew from 4.4m to 7.8m during 14 years of Conservative government.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Voted against the April 2025 employer National Insurance increase. Propose £17.7bn of tax cuts funded by reduced public spending.",
      sourceUrl: "https://obr.uk/efo/economic-and-fiscal-outlook-march-2025/",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Conservatives voted against Labour's NPPF reforms which restored mandatory local housing targets. Their 2024 manifesto proposed 'street votes' and beauty-based planning.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Kemi Badenoch has questioned the pace of net zero policy and cost to consumers, though the party still formally backs the 2050 target.",
      sourceUrl: "https://www.conservatives.com/our-plan",
      sourceLabel: "Conservative Manifesto 2024",
    },
    {
      ...
      status: "proposed",
      detail:
        "Oppose early release scheme. Prison population grew from 85,000 to over 87,000 during the final years of Conservative government.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Labour replaced 'Outstanding / Good / Requires Improvement / Inadequate' with a report card system in 2025. Conservatives would revert this.",
  ...
  reform: [
    {
      ...
      status: "proposed",
      detail:
        "Flagship pledge from Reform's 'Contract with the People'. Proposes Royal Navy interceptions, offshore processing and deportation flights. No legal framework currently exists for this approach.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Covers work visas, student visas and family reunion. IFS estimates this would cause significant labour shortages in health, social care and hospitality.",
      sourceUrl: "https://www.reform.uk/the-contract/",
      sourceLabel: "Reform Contract 2024",
    },
    {
      ...
      status: "proposed",
      detail:
        "Reform explicitly says it would not privatise the NHS but argues management bloat diverts funds from clinical care. NHS England employs approx. 1.5m staff; managers represent under 4% of the workforce.",
      sourceUrl:
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Reform would repeal the 2008 Climate Change Act net zero commitment, end green levies on energy bills and halt offshore wind subsidies. The OBR estimates net zero policies cost households £2.5bn/year in levies.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Raise the personal allowance from £12,570 to £20,000. IFS estimates cost of ~£55bn/year. Reform says it would be funded by cutting foreign aid, diversity programmes and quangos.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Would reduce UK aid from 0.5% to 0.1% of GNI — a cut of ~£10bn/year. UK aid currently funds vaccines, emergency relief and development programmes.",
      sourceUrl: "https://www.reform.uk/the-contract/",
      sourceLabel: "Reform Contract 2024",
    },
    {
      ...
      status: "proposed",
      detail:
        "Follows a trend in Conservative and Reform rhetoric after knife crime reached record recorded levels in 2023–24.",
      sourceUrl:
        "https://www.ons.gov.uk/peoplepopulationandcommunity/crimeandjustice/bulletins/crimeinenglandandwales/latest",
  ...
  libdem: [
    {
      ...
      status: "proposed",
      detail:
        "Funded via reversing non-dom tax cuts and increased wealth taxes. There are currently about 35,000 full-time GPs in England — an 8,000 increase would be a 23% rise.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Lib Dem official policy; would require renegotiating the Trade and Cooperation Agreement. OBR estimated Brexit reduced UK trade intensity by around 15% compared to a no-Brexit counterfactual.",
      sourceUrl:
        "https://obr.uk/docs/dlm_uploads/Working-paper-No.7-How-has-Brexit-affected-UK-trade.pdf",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Higher than Labour's 1.5m homes / 300k/year target. Requires significant green belt release and planning reform beyond what Labour has enacted.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Scotland already allows 16-year-olds to vote in Scottish elections. Labour has not committed to this in Westminster.",
      sourceUrl: "https://www.libdems.org.uk/manifesto",
      sourceLabel: "Lib Dem Manifesto 2024",
    },
    {
      ...
      status: "proposed",
      detail:
        "Would generate estimated £1bn+ in tax revenue, reduce criminal market and allow public health regulation. Similar to systems in Canada, Germany and 24 US states.",
      sourceUrl: "https://www.libdems.org.uk/manifesto",
      sourceLabel: "Lib Dem Manifesto 2024",
    },
    {
      ...
      status: "proposed",
      detail:
        "19 million UK homes have an EPC rating of D or below. Lib Dem emergency retrofit plan would cost ~£6bn/year via a National Wealth Fund.",
      sourceUrl:
        "https://www.gov.uk/government/statistics/english-housing-survey-headline-report-2022-to-2023",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Rwanda scheme was scrapped by Labour in July 2024 (at a cost of £700m with zero flights). Lib Dems propose humanitarian visa pathways instead.",
      sourceUrl:
        "https://www.nao.org.uk/reports/the-rwanda-migration-and-economic-development-partnership/",
  ...
  green: [
    {
      ...
      status: "proposed",
      detail:
        "Funded via wealth tax and increased borrowing. Would accelerate offshore wind, solar and home insulation. The UK currently invests ~£15bn/year in clean energy.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Estimated to raise £50–70bn/year. The wealthiest 1% of households hold 23% of all UK wealth (£6.8tn combined). No EU country currently levies a recurring wealth tax of this scale.",
      sourceUrl:
        "https://www.ons.gov.uk/peoplepopulationandcommunity/personalandhouseholdfinances/incomeandwealth/bulletins/wealthingreatbritainwave7/2018to2020",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Current social care is means-tested — assets above £23,250 must be spent before state support. Up to 165,000 people a year face 'catastrophic' social care costs of over £100,000.",
      sourceUrl:
        "https://www.health.org.uk/publications/long-reads/what-is-happening-to-social-care-funding",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Water companies have paid £72bn in dividends since privatisation in 1989 while infrastructure investment lagged. Rail nationalisation is underway under Labour via Great British Railways.",
      sourceUrl:
        "https://www.theguardian.com/environment/2023/mar/17/water-firms-paid-out-dividends-of-72bn-since-privatisation",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Multiple UK trials showed 4-day week maintained productivity. 61 companies in the 2022 UK trial permanently adopted it. No national legislation proposed yet.",
      sourceUrl:
        "https://autonomy.work/portfolio/uk-pilot-results-and-their-implications-for-the-future-of-the-4-day-week/",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "1.5 million social homes have been sold since 1980, with replacement rates under 10%. England loses ~12,000 social homes per year net. Labour has restricted but not yet abolished Right to Buy.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "English students face average debt of £45,800 on graduation — highest in the OECD. Scotland maintains free tuition for Scottish students.",
  ...
  snp: [
    {
      ...
      status: "proposed",
      detail:
        "Core SNP mission since 1934. The 2014 referendum returned 55% No. SNP argues independence is needed to escape Westminster economic decisions. A second referendum requires Section 30 order from Westminster.",
    ...
    },
    {
      ...
      status: "in-progress",
      detail:
        "NHS Scotland is fully devolved. SNP government has prioritised health spending, but the Scottish budget is constrained by the Barnett formula and UK spending decisions.",
    ...
    },
    {
      ...
      status: "in-progress",
      detail:
        "The SNP government established a Just Transition Commission and opposed Labour's decision to halt new North Sea licences without a transition support package.",
    ...
    },
    {
      ...
      status: "proposed",
      detail:
        "Scotland's population growth is slower than England's; SNP argues a tailored visa system would address regional workforce needs. Immigration is currently a reserved matter.",
      sourceUrl: "https://www.snp.org/manifesto/",
      sourceLabel: "SNP Manifesto 2024",
    },
    {
      ...
      status: "in-progress",
      detail:
        "The Scottish Government has at times offered above-UK pay settlements to public sector workers but is limited by its block grant.",
      sourceUrl: "https://www.snp.org/manifesto/",
      sourceLabel: "SNP Manifesto 2024",
    },
    {
      ...
      status: "done",
      detail:
        "The Housing (Scotland) Act 2022 introduced emergency rent cap legislation — a first in any part of the UK. Challenged by landlord groups but upheld.",
    ...
    },
    {
      ...
      status: "done",
      detail:
        "Scottish students pay no tuition fees at Scottish universities — a policy in place since 2000. Average English graduate debt is £45,800; the comparable Scottish figure is near zero.",
...
// ─── Pledge records with stable IDs (for permalinks) ──────────────────────────

import type { PledgeStatus } from "@/contract/pledges";

export type PledgeRecord = PartyPromise & {
  /** Stable, shareable id used in /parties/pledge/{id}. */
  id: string;
  partyId: string;
  partyName: string;
};
...
/**
 * Flattened, stably-identified pledges. The id is derived from party + issue +
 * the pledge's position within its party, so it stays stable as long as the
 * ordering is preserved (append new pledges at the end of a party's list).
 */
export const ALL_PLEDGES: PledgeRecord[] = Object.entries(PLEDGES).flatMap(([partyId, list]) => {
  const partyName = PARTIES.find((p) => p.id === partyId)?.name ?? partyId;
  const perIssueCount: Record<string, number> = {};
  return list.map((p) => {
    const n = (perIssueCount[p.issue] = (perIssueCount[p.issue] ?? 0) + 1);
    return { ...p, id: `${partyId}-${slug(p.issue)}-${n}`, partyId, partyName };
  });
});

export function getPledgeById(id: string): PledgeRecord | undefined {
  return ALL_PLEDGES.find((p) => p.id === id);
}

/**
 * Display mapping from the legacy PromiseStatus vocabulary to the published
 * six-status methodology rubric. Conservative by design: anything genuinely
 * disputed or not-yet-measurable maps to "not_assessable" rather than asserting
 * a verdict. This is display-only; the underlying assessment is unchanged.
 */
export function toPledgeStatus(s: PromiseStatus): PledgeStatus {
  switch (s) {
    case "done":
      return "delivered";
    case "in-progress":
