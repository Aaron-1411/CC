        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-card border border-border rounded-sm p-5">
            ...
            <dl>
              ...
              <DetailRow label="Instagram" value={booking.instagram ? <a href={`https://instagram.com/${booking.instagram.replace('@','')}`} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline flex items-center gap-1">{booking.instagram} <ExternalLink size={12} /></a> : null} />
            </dl>
          </div>
          ...
          <div className="bg-card border border-border rounded-sm p-5">
            ...
            <dl>
              <DetailRow label="Preferred date" value={booking.preferred_date ? new Date(booking.preferred_date).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' }) : 'Flexible'} />
              <DetailRow label="Time preference" value={booking.time_preference} />
              <DetailRow label="Budget" value={booking.budget_range} />
              <DetailRow label="Additional notes" value={booking.additional_notes ? <p className="whitespace-pre-wrap">{booking.additional_notes}</p> : null} />
            </dl>
          </div>
        </div>
