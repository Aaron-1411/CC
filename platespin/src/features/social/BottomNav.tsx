...
const tab = ({ isActive }: { isActive: boolean }) =>
  `flex min-h-[56px] flex-1 flex-col items-center justify-center gap-0.5 py-2.5 text-[11px] font-medium transition ${
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-white/10 bg-[#0b0f17]/95 pb-[env(safe-area-inset-bottom)] backdrop-blur">
